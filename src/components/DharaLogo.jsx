...
export default function DharaLogo({ className = "h-12 w-auto", showText = true, size = "md" }) {
  ...
  return (
    <div className={`flex items-center gap-3 select-none ${size === "xl" ? "flex-col text-center" : ""}`}>
      {/* High-Quality Custom Himalayan Earth Emblem SVG */}
  ...
  <defs>
    <linearGradient id="riverGrad" x1="0%" y1="0%" x2="0%" y2="100%">
      ...
      <stop offset="100%" stopColor="#38bdf8" />
          ...
          <path d="M100 12 C 130 12, 160 30, 180 60 L140 100 L60 100 Z" fill="#bae6fd" opacity="0.6" />
          ...
          {/* Satellite Orbit Line & Satellite Icon */}
          <path d="M 30,40 Q 100,5 170,40" stroke="#0284c7" strokeWidth="3" strokeDasharray="4,4" />
          ...
          <path d="M 12,130 C 50,170 150,170 188,130 C 170,180 30,180 12,130 Z" fill="#1b4332" />

          {/* Protective Shield & Alert Triangle */}
